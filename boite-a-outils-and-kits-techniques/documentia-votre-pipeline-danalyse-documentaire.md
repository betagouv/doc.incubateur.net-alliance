---
description: >-
  Cette documentation vous guide dans l'intégration et l'usage de l'API
  DocumentIA, pipeline d'analyse documentaire.
---
...
🔗 [https://github.com/betagouv/document-ia/blob/sandbox/document-ia-infra/src/document\_ia\_infra/data/workflow/data/workflows.json](https://github.com/betagouv/document-ia/blob/sandbox/document-ia-infra/src/document_ia_infra/data/workflow/data/workflows.json)
...
🔗 [https://github.com/betagouv/document-ia/tree/sandbox/document-ia-schemas/src/document\_ia\_schemas](https://github.com/betagouv/document-ia/tree/sandbox/document-ia-schemas/src/document_ia_schemas)
...
🔗 [https://github.com/betagouv/document-ia/tree/sandbox/document-ia-api/bruno-api](https://github.com/betagouv/document-ia/tree/sandbox/document-ia-api/bruno-api)
